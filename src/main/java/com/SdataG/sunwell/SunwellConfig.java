 ...
 * to touch the ModConfigSpec accessors on the hot path.
 */
public final class SunwellConfig {
    ...
    private static final ModConfigSpec.IntValue MAX_DEPTH;
    private static final ModConfigSpec.IntValue CONE_SPREAD;
    private static final ModConfigSpec.IntValue SKY_LEVEL;
    private static final ModConfigSpec.BooleanValue ATTENUATE_BY_DEPTH;
    private static final ModConfigSpec.BooleanValue ENABLE_UNDEAD_BURNING;
    private static final ModConfigSpec.BooleanValue BLOCK_HOSTILE_SPAWNS;
    private static final ModConfigSpec.BooleanValue FOLLOW_DAY_NIGHT_CYCLE;
    private static final ModConfigSpec.BooleanValue RESPOND_TO_WEATHER;
    private static final ModConfigSpec.BooleanValue RESPOND_TO_SURFACE_LIGHT;
    private static final ModConfigSpec.BooleanValue LANTERN_FLUX;
    private static final ModConfigSpec.BooleanValue ALLOW_RAIN_THROUGH;
    private static final ModConfigSpec.BooleanValue SNOW_ACCUMULATION;
    private static final ModConfigSpec.IntValue SNOW_ACCUMULATE_ODDS;
    private static final ModConfigSpec.IntValue SNOW_MAX_LAYERS;
    private static final ModConfigSpec.BooleanValue WEATHER_SHAFT_PARTICLES;
    private static final ModConfigSpec.IntValue LIGHTNING_THROUGH_ODDS;
    private static final ModConfigSpec.IntValue LIGHTNING_ROD_BOOST;
    private static final ModConfigSpec.BooleanValue LIGHTNING_VISUAL_ONLY;
    private static final ModConfigSpec.IntValue NODE_BUDGET_PER_TICK;
    private static final ModConfigSpec.IntValue CHUNK_BUDGET_PER_TICK;
    private static final ModConfigSpec.BooleanValue DEBUG_OPACITY_CHURN;
    private static final ModConfigSpec.BooleanValue DEBUG_SKY_STATE;
    private static final ModConfigSpec.BooleanValue DEBUG_WEATHER_PARTICLES;
    private static final ModConfigSpec.BooleanValue DEBUG_LIGHTNING;
