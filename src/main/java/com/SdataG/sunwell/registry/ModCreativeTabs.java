 ...
 */
@Mod.EventBusSubscriber(modid = Sunwell.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public final class ModCreativeTabs {
    ...
    public static void onBuildContents(BuildCreativeModeTabContentsEvent event) {
        ...
        // putAfter rather than accept(): accept() appends to the end of the tab, which would bury it
        // under every banner and candle. This lands it directly beside the block it is a variant of.
